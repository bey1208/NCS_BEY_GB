...
<header id="hd" class="top">
    ...
    <div id="hd_wrapper">
        <div id="snsD">
          <a class="snsA1" href="https://www.facebook.com/gamsungcoffee/" title="페이스북" target="_blank"></a>
            <strong>16,252</strong>
            <span>건</span>
          <a class="snsA2" href="https://www.instagram.com/gamsungcoffee_official/" title="인스타그" target="_blank"></a>
            <strong>11,023</strong>
            <span>follow</span>
        </div>
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="//www.감성커피.com/img/common/bi.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
        <div id="hd_btn">

            <button type="button" class="hd_menu_btn">
            ...
            <ul id="menu">
              <div id="logo1">
                  <a href="<?php echo G5_URL ?>">
                    <img src="//www.감성커피.com/img/common/bi.png" alt="<?php echo $config['cf_title']; ?>">
                  </a>
              </div>
            <?php
            $menu_datas = get_menu_db(1, true);
...
<div id="wrapper">
  ...
  // 테마의 스킨을 사용하려면 theme/basic 과 같이 지정
   echo latest('slider_baner', 'slider_baner', 5, 23);
  ?>
    <div id="container">
